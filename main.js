...
if (ganhador == 0) {
    document.getElementById('menssagem').innerHTML = "EMPATE"

} else if (ganhador == 1) {
    document.getElementById('menssagem').innerHTML = "JULIANA GANHOU".jogadorPontos++;

} else if (ganhador == 2) {
    document.getElementById('menssagem').innerHTML = computadorPontos++;
}
